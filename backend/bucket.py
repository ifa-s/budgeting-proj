...
class BudgetBucket:
    """
    A budget bucket that allocates money as a percentage.
    
    Attributes:
        name (str): The name of the budget bucket
    ...
    def __init__(self, name: str, percentage: float, current_value: float = 0.0):
        """
        Initialize a budget bucket.
        
        Args:
            name (str): Name of the budget bucket
    ...
    def __str__(self) -> str:
        ...
        return (f"BudgetBucket(name='{self.name}', "
